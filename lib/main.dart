...
class _MainPageState extends State<MainPage> {
  ...
  Future<void> _loadModelInfo() async {
    try {
      ...
      // Ignore error jika belum connected
    }
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          // Clear history button (only show on Performance tab)
      ...
      body: IndexedStack(
        index: _currentIndex,
        children: [
          const TestRunnerPage(), // 0: API Test
          const BatchPredictionPage(), // 1: Predict Batch
          HomePage(onTestComplete: _onTestComplete), // 2: Predict Single
          const MetricsPage(), // 3: Server Metrics
          PerformancePage(results: _testHistory), // 4: Performance
        ],
      ),
